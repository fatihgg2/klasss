...
def panel_markup_1(_, videoid, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="⏯ Sürdürmek", callback_data=f"ADMIN Skip|{chat_id}"
            ),
            InlineKeyboardButton(
                text="⏹ Durmak", callback_data=f"ADMIN Stop|{chat_id}"
            ),
        ],
        [
            InlineKeyboardButton(
...
def panel_markup_2(_, videoid, chat_id):
    buttons = [
        [
            InlineKeyboardButton(
                text="🔇 Sesini kapatmak", callback_data=f"ADMIN Mute|{chat_id}"
            ),
            InlineKeyboardButton(
                text="🔊 Sesini Açmak",
